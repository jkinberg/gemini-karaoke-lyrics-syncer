...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({
  ...
  // Feedback button below scrubber
  const feedbackButton = (
    <div className="px-4 pb-2 bg-black">
      <a
        ...
        className="flex items-center justify-center gap-2 py-2 px-4 rounded-xl border border-zinc-700 hover:border-zinc-600 text-zinc-400 hover:text-zinc-300 text-sm transition-colors"
      >
        <FeedbackIcon />
